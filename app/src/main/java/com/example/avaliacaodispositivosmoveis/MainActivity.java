...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView tabelaPaciente = findViewById(R.id.tabelaPaciente);
        ...
        tabelaPaciente.setAdapter(adapter);

        tabelaPaciente.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
